      ...
      <div className="max-w-md mx-auto bg-white rounded-3xl border border-orange-100/60 shadow-sm p-6 md:p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Join RecipeHub and start sharing your favourite dishes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">
              Confirm Password
            </label>
            <input
              type={showPassword ? "text" : "password"}
            ...
            {errors.confirmPassword && (
              <p className="text-xs text-rose-600 mt-1.5 font-medium">{errors.confirmPassword}</p>
            )}
          </div>
